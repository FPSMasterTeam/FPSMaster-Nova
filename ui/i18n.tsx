...
const ZH: Dict = {
  ...
  'oobe.status.connecting': '正在连接客户端…',
  'oobe.status.ready': '已就绪，可稍后在设置中修改',
  ...
  'music.trial': '试听',
  'music.trialTip': 'VIP 歌曲，当前仅播放试听片段，登录会员后可播放完整版',
  'music.source.netease': '网易云',
  'music.source.qq': 'QQ音乐',
  'music.qqLoggedIn': 'QQ 已登录',
  'music.qqScanPrompt': '请用手机 QQ 扫码登录',
  'music.searching': '搜索中...',
  'music.noSearchResults': '没有找到相关歌曲',
  'music.searchResults': '搜索结果',
  'music.qqToplist': '巅峰榜·热歌',
  'music.back': '返回',
  'music.playlist': '歌单',
  'music.songs': '首',
  'music.playAll': '播放全部',
  'music.qqLoginTitle': 'QQ音乐 登录',
  'music.or': '或',
  'music.qqCookieTitle': 'QQ音乐 Cookie 登录',
  'music.qqCookieHelp': '浏览器登录 y.qq.com 后，按 F12 打开开发者工具 → Application → Cookies，复制 uin（去掉前面的 o0）和 qm_keyst 两个值粘贴到下方。',
  'music.qqCookieMissing': '请填写 uin 和 qm_keyst',
  'music.qqCookieFailed': '登录失败，请检查 Cookie 是否正确',
  ...
  'music.dailyRecommendDesc': '根据你的口味生成 · {count} 首',
...
const EN: Dict = {
  ...
  'oobe.status.connecting': 'Connecting to client…',
  'oobe.status.ready': 'Ready — you can change these later in settings',
  ...
  'music.trial': 'Trial',
  'music.trialTip': 'VIP song — only a preview clip plays; log in with membership for the full track',
  'music.source.netease': 'NetEase',
  'music.source.qq': 'QQ Music',
  'music.qqLoggedIn': 'QQ Signed In',
  'music.qqScanPrompt': 'Scan with Mobile QQ to sign in',
  'music.searching': 'Searching...',
  'music.noSearchResults': 'No songs found',
  'music.searchResults': 'Search Results',
  'music.qqToplist': 'Top Chart',
  'music.back': 'Back',
  'music.playlist': 'Playlist',
  'music.songs': 'songs',
  'music.playAll': 'Play All',
  'music.qqLoginTitle': 'QQ Music Login',
  'music.or': 'or',
  'music.qqCookieTitle': 'QQ Music Cookie Login',
  'music.qqCookieHelp': 'Log in to y.qq.com in your browser, open DevTools (F12) → Application → Cookies, then copy the uin (drop the leading o0) and qm_keyst values here.',
  'music.qqCookieMissing': 'Please enter both uin and qm_keyst',
  'music.qqCookieFailed': 'Login failed, please check the cookie values',
  ...
  'music.dailyRecommendDesc': 'Curated for you · {count} tracks',
